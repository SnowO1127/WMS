<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierAdd.aspx.cs" Inherits="WMS.Application.BasicData.SupplierAdd" %>
...
<head runat="server">
    ...
    <script>
            ...
            if (supplierid) {
                $.ajax({
                    ...
                    success: function (jsonresult) {
                        $("#supplier_add_form").form('load', jsonresult.Obj);
                    }
                })
            }
        });
        ...
        var f_save = function ($dialog, $grid, $pjq) {
            if ($('#supplier_add_form').form('validate')) {
                var url;
                if (supplierid) {
                    url = "../../datasorce/ap_supplier.ashx?action=updatesupplier";
                } else {
                    url = "../../datasorce/ap_supplier.ashx?action=addsupplier";
                }

                var data = sy.serializeObject($('#supplier_add_form'));
